...
/**
 * <p>Test case for {@link name.paulevans.samplecodeprojects.model.Product}</p>
 * 
 * @author Paul R Evans
 * @version $Id$
 *
...
public class TestProduct extends TestCase {
	...
	/**
	 * <p>Test for {@link name.paulevans.samplecodeprojects.model.Product#Product(java.math.BigDecimal, String)}</p>
	 */
	...
	/**
	 * <p>Test for {@link name.paulevans.samplecodeprojects.model.Product#Product()}</p>
	 */
	...
	/**
	 * <p>Test for {@link name.paulevans.samplecodeprojects.model.Product#Product(Product)}</p>
	 */
	...
	/**
	 * <p>Test for both {@link name.paulevans.samplecodeprojects.model.Product#setDescription(String)}
	 * and {@link name.paulevans.samplecodeprojects.model.Product#getDescription()}</p>.
	 */
	...
	/**
	 * <p>Test for both {@link name.paulevans.samplecodeprojects.model.Product#setRetailPrice(BigDecimal)}
	 * and {@link name.paulevans.samplecodeprojects.model.Product#getRetailPrice()}</p>
	 */
	...
	/**
	 * <p>Test for both {@link name.paulevans.samplecodeprojects.model.Product#setName(String)}
	 * and {@link name.paulevans.samplecodeprojects.model.Product#getName()}</p>.
	 */
