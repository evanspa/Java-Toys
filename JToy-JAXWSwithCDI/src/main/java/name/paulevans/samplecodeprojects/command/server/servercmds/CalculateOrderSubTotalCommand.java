package name.paulevans.samplecodeprojects.command.server.servercmds;

import java.math.BigDecimal;

import name.paulevans.samplecodeprojects.command.CommandSupport;
import name.paulevans.samplecodeprojects.command.server.productpriceresolver.ProductPriceResolver;
import name.paulevans.samplecodeprojects.command.server.productpriceresolver.impl.InMemoryProductPriceResolver;
 ...
 * property set (via {@link #setOrder(name.paulevans.samplecodeprojects.model.Order)})</p>
 * 
 * @author Paul R Evans
 * @version $Id$
 *
